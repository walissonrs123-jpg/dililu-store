...
- Autenticação ponta a ponta PASS na tentativa 2 do [workflow 36133208998](https://github.com/walissonrs123-jpg/dililu-store/actions/runs/36133208998). A primeira tentativa revelou subject imutável do GitHub; somente o subject da trust foi corrigido com IDs confirmados pela API, preservando repositório/main e permissões. `sts get-caller-identity` e comparação da role passaram na única repetição autorizada. Publicador e ativação do domínio exigem autorização separada.
